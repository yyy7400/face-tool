...
var LoginPlugin=React.createClass({displayName: "LoginPlugin",
    ...
    render:function(){
        return (
			React.createElement("div", {className: "clear"}, 
				React.createElement("div", {className: "left help_photo"}, 
					React.createElement("div", {className: "left help", onClick: this.goHelp}, 
						React.createElement("span", {className: "help_icon"}), 
						React.createElement("span", null, "帮助")
					), 
					React.createElement("div", {className: "user_photo", style: {backgroundImage:"url("+_userPhoto+")"}, onClick: this.goUserDetail}
					)
				), 
				React.createElement("div", {className: "left name_out"}, 
					React.createElement("span", {className: "user_name", onClick: this.goUserDetail}, decodeURIComponent(_userName)), 
					React.createElement("span", {className: "log_out", onClick: this.quitPage})
				)
			)
        );
    }
...
ReactDOM.render(
  	React.createElement(LoginPlugin, null),
...
//下拉选择公共组件
var Selepicker = React.createClass({displayName: "Selepicker",
    ...
    render: function() {
        ...
        var optList = this.props.data.map(function(o, i) {
            ...
            return React.createElement("option", {value: i, key: "sele_opt" + i, disabled: disabled}, text)
        });
        ...
        return (
            React.createElement("div", {className: class_name, style: {"display": this.props.data.length > 0 ? "" : "none"}}, 
            	React.createElement("div", {className: class_name + "_title", style: {"display":this.props.title?"":"none"}}, this.props.title), 
                React.createElement("div", {className: class_name + "_picker", ref: "sele_warp"}, 
                    React.createElement("select", {className: "selectpicker", ref: "selectpicker", "data-width": width, "data-dropup-auto": "false", "data-live-search": search, "data-size": size, "data-style": "sele_style", "data-none-selected-text": no_sele}, 
                        optList
                    )
                )
            )
