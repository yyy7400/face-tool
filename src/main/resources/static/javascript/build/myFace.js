var MyFaceContent = React.createClass({displayName: "MyFaceContent",
	id: null,
	...
	render: function(){
		...
		return (
			React.createElement("div", null, 
				React.createElement("div", {className: "my_face_bg", id: "particles-js"}, 
					React.createElement("div", {className: "my_face_container"}, 
						React.createElement("div", {className: "my_face_photo_info"}, 
							React.createElement("p", null, "姓名: ", userName), 
							React.createElement("p", null, "性别: ", sex), 
							React.createElement("p", null, "班级: ", className), 
							React.createElement("p", null, "学号: ", userId), 
							React.createElement("p", null, "人脸: ", React.createElement("span", {style: {"color":this.state.score>0?"green":"red"}}, this.state.score), " 分"), 
							React.createElement("p", {style: {"fontSize":"14px","color":"red","display":this.state.score>0||this.photoSourceType==0?"none":"block"}}, "当前头像分数过低，请重新选择！")
						), 
						React.createElement("div", {className: "my_face_photo_div"}, 
							React.createElement("img", {className: "my_face_photo_block1", src: this.state.userPhotoUrl}), 
				...
				React.createElement("div", {style: {"paddingTop": "40px"}}, 
					React.createElement("div", {className: "my_face_operation_container"}, 
						React.createElement("div", {className: "my_face_operation_notice"}, 
							React.createElement("p", null, "温馨提示 :"), 
							React.createElement("p", null, "1. 本系统支持上传本地照片，进行自主认证，或同步基础平台个人用户头像；"), 
							React.createElement("p", null, "2. 推荐照片像素最低为300*300，人脸部位像素不低于100*100，尽量选择人脸居中显示、光照亮度合适。")
						), 
						React.createElement("div", {className: "my_face_photo_btn_group clearfix"}, 
...
ReactDOM.render(
  	React.createElement(MyFaceContent, null),
